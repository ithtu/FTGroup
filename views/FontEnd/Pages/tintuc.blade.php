            ...
            <div class="col-md-3">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <img class="img-responsive" src="../resources/images/tintuc/{{$tlq->Hinh}}" alt="">/a>
                ...
                <div class="panel panel-default">
                    ...
                    <img class="img-responsive" src="upload/tintuc/{{$tnb->Hinh}}" alt=""></a>
                    ...
                    <p style="padding-left:5px;text-align:justify">{!! $tnb->TomTat !!}</p>
