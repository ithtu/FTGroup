...
@foreach($theloai as $tl)           
    @if(count($tl->loaitin)>0)    
                <div class="row-item row">
                    <h3>
                        <a href="{{route('loaitin',[$tl->id, $tl->TenKhongDau])}}">"{{$tl->Ten}}"</a> |
...
<!-- lấy ra 1 tin hiện cột bên trái, hàm shift trả về dữ liệu kiểu mảng -->
                    ...
                    <div class="col-md-8 border-right">
                        ...
                        @if(isset($tin1["Hinh"]))     
                            <img class="img-responsive" src="../resources/images/tintuc/{{$tin1['Hinh']}}" alt="{{$tin1['Hinh']}}">
                        ...
                        <div class="col-md-7">
                        <h3>{{isset($tin1['TieuDe'])? $tin1['TieuDe']:"Đang cập nhật!"}}</h3>
                        <p>{{isset($tin1['TomTat'])? $tin1['TomTat']:"Đang cập nhật!"}}</p>
                            <a class="btn btn-primary" href="{{route('tintuc',[$tin1->id, $tin1->TieuDeKhongDau])}}">Xem Chi Tiết <span class="glyphicon glyphicon-chevron-right"></span></a>
                        </div>
