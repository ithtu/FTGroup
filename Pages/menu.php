...
<nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav  mr-auto py-0">
			                ...
			                ?>
                            <a href="shop.php?quanly=danhmucsanpham&id=<?php echo $row_danhmuc['id_danhmuc'] ?>" class="nav-item nav-link navbar-menu"><?php echo $row_danhmuc['tendanhmuc'] ?></a>
                            <?php
				            }
			                ?>
                            
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle navbar-menu" data-toggle="dropdown">Pages</a>
